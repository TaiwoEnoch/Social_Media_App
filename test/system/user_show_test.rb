...
#     Post.create(title: 'Post 3', text: 'Post 3 text', commentscounter: 2, likescounter: 4, author: user)
...
#         assert_select '.comment', text: "Comments: #{post.commentscounter}"
#         assert_select '.like', text: "Likes: #{post.likescounter}"
#       end
#     end
...
#     user = users(:one)
#     post = Post.create(title: 'Post 1', text: 'Post 1 text', commentscounter: 5, likescounter: 10, author: user)
